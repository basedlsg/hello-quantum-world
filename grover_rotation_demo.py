...
def grover_rotation_explanation():
    ...
    print("-" * 65)
    print(f"Start     | {amplitudes[0]:>5.2f}  | {amplitudes[1]:>5.2f}  | {amplitudes[2]:>5.2f}   | {amplitudes[3]:>5.2f}  | {amplitudes[target_item]**2:>14.1%}")
    ...
    for iteration in range(1, 4):
        ...
        print(f"Iter {iteration}     | {amplitudes[0]:>5.2f}  | {amplitudes[1]:>5.2f}  | {amplitudes[2]:>5.2f}   | {amplitudes[3]:>5.2f}  | {probability:>14.1%}")
