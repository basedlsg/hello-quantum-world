...
def entanglement_step_by_step():
    ...
    steps = [
        ("1. Prepare qubits", "Prepare", "Cool to near absolute zero, isolate from environment"),
        ("2. Initialize states", "Initialize", "Put qubits in known starting states (usually |0⟩)"),
        ("3. Create superposition", "Superpose", "Apply H gates to put qubits in |0⟩+|1⟩ states"),
        ("4. Apply entangling gate", "Entangle", "CNOT gate creates quantum correlations"),
